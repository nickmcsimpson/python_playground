...
def write_grayscale(filename, pixels):
    ...
    Args:
        ...
        pixels: A rectangular image stored as a sequence of rows. Each row must be an iterable series of integers in the
        range 0-255.
    ...
    with open(filename, 'wb') as bmp:
        ...
        # Color palette - a linear grayscale (would be a way to customize this later)
        for c in range(256):
...
def dimensions(filename):
    """Determine the dimensions in pixels of the BMP image.
